...
%% Load data
log = CassieLog('C:\Users\gibso\workspace\research\cassie_mpc_lip\matlab_mpc_with_standing\ExpLog\2022_02_02_mpctest\DATA.DAT');
...
figure(1)
hold on;
plot(log.Data.t,log.Data.x0_next_tgd_goal./1000)
% set(lg,'visible','off');
% plotbrowser('on')

figure(2)
hold on;
% plot(log.Data.t,log.Data.Vx_tgd);
plot(log.Data.t,log.Data.vx_com_tgd)
legend('goal_dx','dq1');
% set(lg,'visible','off');
% plotbrowser('on')
